...
def get_model_path(model):
    if model == "kimmi-VL-A3B":
        return "/data2/amir/HF_home/models--moonshotai--Kimi-VL-A3B-Thinking-2506/snapshots/35bd9189e1f9e101a0f326de07dd92a25d20f384"
    else:
...
def kimmi_nll_fn(model, input_arr, target_arr, settings:SerializerSettings, transform, count_seps=True, temp=1, cache_model=True):
...
def kimmi_completion_fn(
    ...
    **kwargs
    ...
    for _ in tqdm(range(num_samples // batch_size)):
        ...
        vocab_size = model.get_input_embeddings().weight.shape[0]  # safer than len(tokenizer)
