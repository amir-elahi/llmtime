...
def get_model_path(model):
    if model == "gemma-12b":
        return "/data2/amir/HF_home/models--google--gemma-3-12b-it/snapshots/96b6f1eccf38110c56df3a15bffe176da04bfd80/"
    elif model == "gemma-27b":
        return "/data2/amir/HF_home/models--google--gemma-3-27b-it/snapshots/005ad3404e59d6023443cb575daa05336842228a/"
    else:
...
def gemma_nll_fn(model, input_arr, target_arr, settings:SerializerSettings, transform, count_seps=True, temp=1, cache_model=True):
